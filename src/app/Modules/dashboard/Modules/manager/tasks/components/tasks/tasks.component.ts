...
import { DeletProjectComponent } from '../../../projects/projects/component/delet-project/delet-project.component';
...
openDialog(item:any): void {
  const dialogRef = this._Dialog.open(DeletProjectComponent, {
    data: {isData:item},
  });
